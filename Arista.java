...
public class Arista implements Comparable<Arista>
{
     ...
     * @param vertice1. Extremo o vertice de la arista
     * @param vertice2. Segundo extremo o vertice para formar la arista
     **/
    ...
    {
	if(vertice1.getNombre().compareTo(vertice2.getNombre()) <= 0)
	    {
     ...
     **/
    public Vertice getAdyacenteDe(Vertice actual)
    {
    ...
    /**
     * @return int. Codigo hash para esta arista
     **/
    public int hashCode()
    {
	return (vertice1.getNombre() + vertice2.getNombre()).hashCode();
    }
